      ...
      <main className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="bg-white/60 backdrop-blur-sm border-amber-100">
            ...
            <CardContent>
              <div className="text-2xl font-bold">${ecoScore?.total_money_saved || 0}</div>
              <p className="text-xs text-muted-foreground">
          ...
          <Card className="bg-white/60 backdrop-blur-sm border-amber-100">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{ecoScore?.co2_saved_kg || 0}kg</div>
              <p className="text-xs text-muted-foreground">
          ...
          <Card className="bg-white/60 backdrop-blur-sm border-amber-100">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{ecoScore?.water_saved_liters || 0}L</div>
              <p className="text-xs text-muted-foreground">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card 
            className="bg-white/60 backdrop-blur-sm border-amber-100 cursor-pointer hover:shadow-lg transition-shadow"
            onClick={() => navigate('/products')}
          >
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
          ...
          >
            ...
            <CardContent>
              <p className="text-sm text-gray-600">
                List your near-expiry products and reduce food waste
              </p>
            </CardContent>
          </Card>
        </div>
